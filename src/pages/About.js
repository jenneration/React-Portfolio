      ...
      <div className="row rowAbout" >
        <div className="col-md-7 offset-md-2 col-sm-8 align-self-center justify-content-center about" >
          ...
          <p class-Name="text-center">
            <strong><em>But seriously....</em></strong>
              I'm from Brooklyn, NY, moved around too much, and eventually settled in
              D.C. Graduated from the Corcoran College of Art + Design with a
              degree in Fine Art Photography only to realize that while my love for travel and capturing images is true,
              I hate the bit about looking for a new gig every week.</p>
          <p>THE NEW PLAN: Code for a living, photograph for pleasure, and get back to finding great places to wander
              around in. <span className="heart"> &#10084; </span></p>
        </div>
      </div>
    </div>
  </div >
